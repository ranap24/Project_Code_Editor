...
const CourseCard = ({ imageSrc, imageTitle, Level, time, title,certificate }) => {
    return (
        <div className='w-[249px] h-fit bg-paperwhite rounded-4xl border-2 border-paperblack flex flex-col justify-center items-center gap-4 p-8'>
            ...
            <div className='w-[184px] h-[40px] bg-paperblack rounded-4xl flex flex-row justify-center items-center gap-4 px-auto mt-4'>
                <p className='font-raleway font-normal text-paperwhite'>{certificate ? "View Certificate" : "Know more"}</p>
